...
export default function SignUp() {
  ...
  async function dataSubmit(data) {
    const response = await fetch('https://quote-mnpk.onrender.com/signup', {
      method: "POST",
          ...
          <div className="modal-content rounded-4 shadow">
            <div className="container">
              ...
              <div className="modal-header p-5 pb-4 border-bottom-0 d-flex justify-content-center align-items-center">
                ...
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={handleSignup}></button>
              </div>

              <h1 className="fw-bold mb-3 fs-2 text-center">Create Free Account</h1>
              ...
              <div className="modal-body p-5 pt-0">
                <Form onSubmit={handleSubmit}>
                  <div className="form-floating mb-3">
                    <input type="text" className="form-control rounded-3" id="floatingInput" placeholder="Name" name='name' />
                    <label htmlFor="floatingInput">Name</label>
                  </div>
                  <div className="form-floating mb-3">
                    <input type="email" className="form-control rounded-3" id="floatingEmail" placeholder="Email" name='email' />
                  ...
                  <button className="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit" style={{ backgroundColor: "rgb(85, 212, 193)" }}>Create Free Account</button>
                  <p className="text-center" style={{ fontSize: "12px" }}>By clicking on “Create Account”, you agree to our Terms of Use and License Terms. In our Privacy Policy, we explain how we process your personal data and what rights you have.
                  </p>
